...
void Game::DrawGame()
{
    ...
    sf::RectangleShape arribaShape(sf::Vector2f(500, 5));
    arribaShape.setFillColor(sf::Color::Red);
    arribaShape.setPosition(0, 0);
    wnd->draw(arribaShape);
    ...
    //sf::RectangleShape obj_fijo(sf::Vector2f())
...
void Game::DoEvents()
{
    ...
    controlBodyBox->SetAwake(true); // Activa el cuerpo para que responda a fuerzas y colisiones
    if (Keyboard::isKeyPressed(Keyboard::Left))
        controlBodyBox->SetLinearVelocity(b2Vec2(-50.0f, 0.0f));
    if (Keyboard::isKeyPressed(Keyboard::Right))
        controlBodyBox->SetLinearVelocity(b2Vec2(50.0f, 0.0f));
    if (Keyboard::isKeyPressed(Keyboard::Down))
        controlBodyBox->SetLinearVelocity(b2Vec2(0.0f, 50.0f));
...
void Game::InitPhysics()
{
    ...
    controlBodyBox = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 10.0f, 5.0f, 1.0f, 0.5, 0.3f);
    controlBodyBox->SetTransform(b2Vec2(50.0f, 50.0f), 0.0f);
